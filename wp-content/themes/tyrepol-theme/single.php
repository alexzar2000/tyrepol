  ...
  <section class="article article--top" id="wpis">
    <div class="article__inner">
      ...
      <a class="article__back reveal" href="<?php echo esc_url(get_permalink(get_option('page_for_posts')) ?: home_url('/aktualnosci/')); ?>">
        ...
        <?php tyrepol_esc_html_e('Powrót do aktualności', 'Back to news'); ?>
      </a>
      ...
      <div class="article__share reveal">
        <span class="article__share-label"><?php tyrepol_esc_html_e('Udostępnij:', 'Share:'); ?></span>
        <a class="article__share-link" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode(get_permalink()); ?>" target="_blank" rel="noopener" aria-label="<?php tyrepol_esc_attr_e('Udostępnij na Facebooku', 'Share on Facebook'); ?>">
        ...
        <a class="article__share-link" href="https://www.linkedin.com/sharing/share-offsite/?url=<?php echo urlencode(get_permalink()); ?>" target="_blank" rel="noopener" aria-label="<?php tyrepol_esc_attr_e('Udostępnij na LinkedIn', 'Share on LinkedIn'); ?>">
    ...
    <div class="article__related">
      <h2 class="article__related-title reveal"><?php tyrepol_esc_html_e('Zobacz również', 'See also'); ?></h2>
